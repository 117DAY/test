...
import com.mnnu.examine.modules.question.dao.QuestionTypeDao;
...
public class QuestionTypeServiceImpl extends ServiceImpl<QuestionTypeDao, QuestionTypeEntity> implements QuestionTypeService {
    ...
    @Override
    public QuestionTypeEntity getRoot(List<QuestionTypeEntity> list, QuestionTypeEntity typeEntity) {
        ...
        return getRoot(list, parentType);
    }
